...
10      60    0    27   -27   1.010   100     1       100     0;   % Subtransmission generator (single unit)
12      40    13   16   -16   1.010   100     1        75     0;   % Aggregated distribution generator (n=2)
13      50    17   18   -18   1.010   100     1        70     0;   % Aggregated distribution generator (n=2)
];
